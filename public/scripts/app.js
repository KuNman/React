...
var Person = function () {
  ...
  _createClass(Person, [{
    key: 'getDescrtiption',
    value: function getDescrtiption() {
...
var Traveller = function (_Person) {
  ...
  _createClass(Traveller, [{
    key: 'getDescrtiption',
    value: function getDescrtiption() {
      var description = _get(Traveller.prototype.__proto__ || Object.getPrototypeOf(Traveller.prototype), 'getDescrtiption', this).call(this);
...
var me = new Person('Adam Nowacki', 1);
var descriptionMe = me.getDescrtiption();

var you = new Person();
var descriptionYou = you.getDescrtiption();

console.log(descriptionMe);
console.log(descriptionYou);

var traveller = new Traveller('Adam Nowacki', 2, 'Polska');
var descriptionTraveller = traveller.getDescrtiption();
